...
export const ADMIN_NAV_SECTIONS: AdminNavSection[] = [
  ...
  { slug: "network_zones",     label: "Network Zones",          url: "/dashboard/network-zones",         icon: Network },
  { slug: "network_zone_groups",       label: "Network Zone Groups",            url: "/dashboard/network-zone-groups",           icon: Layers },
